...
SELECT * FROM (VALUES ("ANY", "/bin/cat", (SELECT id FROM WhitelistClass WHERE class="Filesystem/Path/Executable")),
                      ...
                      ("ANY", "/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libnss_dns.so.2", (SELECT id FROM WhitelistClass WHERE class="Filesystem/Path/Library")),
                      ...
                      ("ANY", "/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libnss_mdns4_minimal.so.2", (SELECT id FROM WhitelistClass WHERE class="Filesystem/Path/Library")),
