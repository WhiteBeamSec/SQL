...
SELECT * FROM (VALUES ("/bin/bash", "664d9dd14597b83aebf765d2d054fa40ad7a93ffeca43ee3bba596517db2c39b", (SELECT id FROM WhitelistClass WHERE class="Hash/BLAKE3")),
                      ...
                      ("/usr/src/whitebeam/target/release/whitebeam", "/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libssl.so.1.1", (SELECT id FROM WhitelistClass WHERE class="Filesystem/Path/Library")),
                      ("/usr/src/whitebeam/target/release/whitebeam", "/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libcrypto.so.1.1", (SELECT id FROM WhitelistClass WHERE class="Filesystem/Path/Library")),
