...
WITH local_const AS (SELECT (SELECT id FROM WhitelistClass WHERE class="Filesystem/Path/Executable") AS Executable,
                            ...
                            (SELECT id FROM WhitelistClass WHERE class="Network/Range/Accept") AS Accept,
...
SELECT * FROM (VALUES ("ANY", "/usr/sbin/apache2", "4aadc76a6af5d65197cb9cdf7d7a6945772539c48c0120919f38f77af29c0f53", (SELECT BLAKE3 FROM local_const)),
                      ...
                      ("ANY", "/usr/sbin/apache2", "172.16.0.0/12:0-65535", (SELECT Accept FROM local_const)),
                      ...
                      ("ANY", "/bin/sh", (SELECT LibraryPath FROM global_const) || "libtinfo.so.6", (SELECT Library FROM local_const)),
                      ("ANY", "/usr/bin/sh", (SELECT LibraryPath FROM global_const) || "libtinfo.so.6", (SELECT Library FROM local_const)),
                      ...
                      ("ANY", "/usr/src/whitebeam/target/release/whitebeam", "0.0.0.0/0:11998", (SELECT Bind FROM local_const)));
