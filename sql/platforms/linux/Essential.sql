...
SELECT * FROM (VALUES -- Execution
                      ...
                      ((SELECT id FROM LibcHook WHERE symbol="fopen"), FIXME_T, (SELECT OpenFileDescriptor FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="fopen64"), FIXME_T, (SELECT OpenFileDescriptor FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="truncate"), FIXME_T, (SELECT OpenFileDescriptor FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="truncate64"), FIXME_T, (SELECT OpenFileDescriptor FROM local_const), NULL),
                      -- Open directory file descriptor
                      ((SELECT id FROM LibcHook WHERE symbol="chmod"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="chown"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="creat"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="creat64"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="lchown"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="link"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="link"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="open"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="open64"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="rename"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="rename"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="mkdir"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="rmdir"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="symlink"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="unlink"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="mknod"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__open"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__open_2"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__open64"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__open64_2"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__xmknod"), FIXME_T, (SELECT SplitFilePath FROM local_const), NULL),
                      -- Combine directory components in *at* functions to prevent directory traversal race conditions
                      ((SELECT id FROM LibcHook WHERE symbol="fchmodat"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="fchownat"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="linkat"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="linkat"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="openat"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="openat64"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="renameat"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="renameat"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="renameat2"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="renameat2"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="mkdirat"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="symlinkat"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="unlinkat"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="mknodat"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__openat_2"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__openat64_2"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__xmknodat"), FIXME_T, (SELECT CombineDirectory FROM local_const), NULL),
                      -- Check if the target directory is whitelisted (if this is a write operation)
                      ((SELECT id FROM LibcHook WHERE symbol="chmod"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="chown"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="creat"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="creat64"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="lchown"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="link"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="link"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="open"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="open64"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="rename"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="rename"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="mkdir"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="rmdir"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="symlink"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="unlink"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="mknod"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__open"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__open_2"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__open64"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__open64_2"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__xmknod"), FIXME_F, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="truncate"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="truncate64"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="fopen"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="fopen64"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="fchmod"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="fchown"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="fdopen"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="ftruncate"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="ftruncate64"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="fchmodat"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="fchownat"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="linkat"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="linkat"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="openat"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="openat64"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="renameat"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="renameat"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="renameat2"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="renameat2"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="mkdirat"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="symlinkat"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="unlinkat"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="mknodat"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__openat_2"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__openat64_2"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__xmknodat"), FIXME_T, (SELECT VerifyCanWrite FROM local_const), NULL),
                      -- Convert variadic parameters into regular parameters
                      ((SELECT id FROM LibcHook WHERE symbol="open"), FIXME_T, (SELECT ConsumeVariadic FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="open64"), FIXME_T, (SELECT ConsumeVariadic FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="openat"), FIXME_T, (SELECT ConsumeVariadic FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="openat64"), FIXME_T, (SELECT ConsumeVariadic FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__open"), FIXME_T, (SELECT ConsumeVariadic FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__open_2"), FIXME_T, (SELECT ConsumeVariadic FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__open64"), FIXME_T, (SELECT ConsumeVariadic FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__open64_2"), FIXME_T, (SELECT ConsumeVariadic FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__openat_2"), FIXME_T, (SELECT ConsumeVariadic FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="__openat64_2"), FIXME_T, (SELECT ConsumeVariadic FROM local_const), NULL),
                      -- Add open flags
                      ...
                      ((SELECT id FROM LibcHook WHERE symbol="lchown"), FIXME_F, (SELECT AddInt FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="link"), FIXME_F, (SELECT AddInt FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="rmdir"), FIXME_F, (SELECT AddInt FROM local_const), NULL),
                      ((SELECT id FROM LibcHook WHERE symbol="unlink"), FIXME_F, (SELECT AddInt FROM local_const), NULL),
                      */
