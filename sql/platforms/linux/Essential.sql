...
INSERT INTO Rule (arg, action) VALUES -- Execution
                                      ...
                                      ((SELECT id FROM Argument WHERE hook=(SELECT id FROM Hook WHERE library = "/lib/x86_64-linux-gnu/libc.so.6" AND symbol="execve") AND name="pathname"), (SELECT id FROM Action WHERE name="VerifyCanExecute")),
                                      ((SELECT id FROM Argument WHERE hook=(SELECT id FROM Hook WHERE library = "/lib/x86_64-linux-gnu/libc.so.6" AND symbol="execve") AND name="pathname"), (SELECT id FROM Action WHERE name="VerifyFileHash")),
