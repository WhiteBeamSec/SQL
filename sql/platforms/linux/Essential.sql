...
SELECT * FROM (VALUES -- AddInt
                      ...
                      ("posix_spawn", NULL), ("/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libc.so.6", last_insert_rowid()),
...
SELECT * FROM (VALUES -- Execution
                      ...
                      ((SELECT id FROM Argument WHERE hook=(SELECT id FROM Hook WHERE library = "/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libc.so.6" AND symbol="posix_spawnp") AND name="file"), TRUE, (SELECT id FROM Action WHERE name="CanonicalizePath"), NULL),
                      ...
                      ((SELECT id FROM Argument WHERE hook=(SELECT id FROM Hook WHERE library = "/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libc.so.6" AND symbol="posix_spawn") AND name="path"), TRUE, (SELECT id FROM Action WHERE name="VerifyCanExecute"), NULL),
                      ((SELECT id FROM Argument WHERE hook=(SELECT id FROM Hook WHERE library = "/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libc.so.6" AND symbol="posix_spawnp") AND name="file"), TRUE, (SELECT id FROM Action WHERE name="VerifyCanExecute"), NULL),
                      ...
                      ((SELECT id FROM Argument WHERE hook=(SELECT id FROM Hook WHERE library = "/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libc.so.6" AND symbol="posix_spawn") AND name="path"), TRUE, (SELECT id FROM Action WHERE name="VerifyFileHash"), NULL),
                      ((SELECT id FROM Argument WHERE hook=(SELECT id FROM Hook WHERE library = "/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libc.so.6" AND symbol="posix_spawnp") AND name="file"), TRUE, (SELECT id FROM Action WHERE name="VerifyFileHash"), NULL),
                      ...
                      ((SELECT id FROM Argument WHERE hook=(SELECT id FROM Hook WHERE library = "/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libc.so.6" AND symbol="posix_spawn") AND name="envp"), TRUE, (SELECT id FROM Action WHERE name="FilterEnvironment"), NULL),
                      ((SELECT id FROM Argument WHERE hook=(SELECT id FROM Hook WHERE library = "/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libc.so.6" AND symbol="posix_spawnp") AND name="envp"), TRUE, (SELECT id FROM Action WHERE name="FilterEnvironment"), NULL),
                      ...
                      ((SELECT id FROM Argument WHERE hook=(SELECT id FROM Hook WHERE library = "/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libc.so.6" AND symbol="posix_spawnp") AND name="pid"), FALSE, (SELECT id FROM Action WHERE name="RedirectFunction"), (SELECT id FROM ActionArgument WHERE value=("/lib/" || (SELECT const.arch FROM const) || "-linux-gnu/libc.so.6") AND next=(SELECT id FROM ActionArgument WHERE value="posix_spawn" AND next IS NULL))),
